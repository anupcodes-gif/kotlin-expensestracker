...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public FirebaseFirestoreLibraryAccessors getFirestore() { return laccForFirebaseFirestoreLibraryAccessors; }
    ...
    public static class FirebaseFirestoreLibraryAccessors extends SubDependencyFactory {
        ...
        public FirebaseFirestoreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKtx() { return create("firebase.firestore.ktx"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: googlePlayServicesAuth (21.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getGooglePlayServicesAuth() { return getVersion("googlePlayServicesAuth"); }

            /**
             * Returns the version associated to this alias: hilt (2.52)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: ksp (2.0.21-1.0.27)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: lottie (6.5.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: navigation (2.8.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final AndroidxPluginAccessors baccForAndroidxPluginAccessors = new AndroidxPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of bundles at plugins.androidx
         */
        public AndroidxPluginAccessors getAndroidx() { return baccForAndroidxPluginAccessors; }
    ...
    public static class AndroidxPluginAccessors extends PluginFactory {
        private final AndroidxNavigationPluginAccessors baccForAndroidxNavigationPluginAccessors = new AndroidxNavigationPluginAccessors(providers, config);

        public AndroidxPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of bundles at plugins.androidx.navigation
         */
        public AndroidxNavigationPluginAccessors getNavigation() { return baccForAndroidxNavigationPluginAccessors; }
    ...
    public static class AndroidxNavigationPluginAccessors extends PluginFactory {
        ...
        public AndroidxNavigationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for androidx.navigation.safeargs to the plugin id 'androidx.navigation.safeargs.kotlin'
             * This plugin was declared in catalog libs.versions.toml
             */
    ...
    public static class GooglePluginAccessors extends PluginFactory {
        private final GoogleGmsPluginAccessors baccForGoogleGmsPluginAccessors = new GoogleGmsPluginAccessors(providers, config);

        public GooglePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of bundles at plugins.google.gms
         */
        public GoogleGmsPluginAccessors getGms() { return baccForGoogleGmsPluginAccessors; }

    }

    public static class GoogleGmsPluginAccessors extends PluginFactory {
        private final GoogleGmsGooglePluginAccessors baccForGoogleGmsGooglePluginAccessors = new GoogleGmsGooglePluginAccessors(providers, config);

        public GoogleGmsPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of bundles at plugins.google.gms.google
         */
        public GoogleGmsGooglePluginAccessors getGoogle() { return baccForGoogleGmsGooglePluginAccessors; }
