...
public abstract class Hilt_AddExpenseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddExpenseFragment() {
    super();
  }

  Hilt_AddExpenseFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddExpenseFragment_GeneratedInjector) this.generatedComponent()).injectAddExpenseFragment(UnsafeCasts.<AddExpenseFragment>unsafeCast(this));
    }
  }
